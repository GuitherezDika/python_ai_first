...
Foto FFB dari kebun
Lighting pagi/siang
Kondisi real (kotor, hujan, blur)
Label manual 8 kelas
Model (Phase 1.3)
MobileNetV3 / EfficientNet-lite
Output: 8 class softmax
Target: jalan di HP / kamera kebun (edge AI)

🚀 Rekomendasi urutan kamu:
Label schema (DONE)
Dataset strategy (NEXT)
Model strategy
Training pipeline
Convert ke TFLite / LiteRT
Integrasi camera app
==============
